        ...
        <form class="form form-horizontal" id="form-article-add" onsubmit="return false">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请填写视频名称" name="video_name" value="{{ $video->video_name }}">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请填写视频链接。提示：rtmp流不支持ios" name="video_link" value="{{ $video->video_link }}">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请填写视频宽度" name="width" value="{{ $video->width }}">
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请填写视频高度" name="height" value="{{ $video->height }}">
                </div>
            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $(".js-submit").click(function () {
                ...
                $.ajax({
                    url: "{{ url('admin/video/update', $video->id) }}",
                    data: {
